...
class CommonErrors {
    companion object{
        ...
        const val notValidName = "El nombre debe ser alfanumérico y estar entre 2 y 10"
        const val notValidDescription = "La descripción no puede tener más de 30 caracteres"
